          ...
          <div className='flex flex-col gap-4'>
            ...
            <div className='flex gap-12 max-[900px]:flex-col max-[900px]:gap-8'>
              ...
              <div className='flex flex-col gap-6 flex-1 font-dm-sans text-[16px] leading-[1.75] text-foreground max-[640px]:text-[15px]'>
                <p>
                  Hello, I&apos;m Makibul Hossain Tamim, a Junior UI/UX Designer
                  based in Dhaka. I specialize in turning complex ideas into
                  simple, intuitive, and visually engaging digital experiences.
                  With a background in Computer Science and hands-on industry
                  experience, I combine creativity with technical understanding
                  to deliver effective design solutions.
                </p>
                <p>
                  I work across the full design process — from user research and
                  journey mapping to high-fidelity Figma prototypes and
                  developer handoff — ensuring usability and consistency at
                  every stage. I hold a B.Sc. in Computer Science and
                  Engineering from IUBAT (2025) and enjoy solving complex
